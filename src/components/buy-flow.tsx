...
export default function BuyFlow({ product }: { product: FlowProduct }) {
  ...
  // lock page scroll (incl. Lenis) while the overlay is open
  useEffect(() => {
            ...
            <div className="flex-1 overflow-y-auto p-6">
              ...
              {stage === "success" && (
                <div className="py-4 text-center">
                  <div className="mx-auto grid size-20 place-items-center rounded-full bg-emerald-500 text-white shadow-lg">
                  ...
                  <div className="mx-auto mt-4 flex max-w-xs justify-between rounded-2xl bg-emerald-500/[0.08] p-4 text-sm font-bold ring-1 ring-inset ring-emerald-500/20">
  ...
  return (
    <>
      ...
      {/* rendered at <body> level so it always covers the whole page */}
